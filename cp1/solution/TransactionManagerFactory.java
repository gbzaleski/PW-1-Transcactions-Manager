...
public final class TransactionManagerFactory {
	 ...
	 */
	public final static TransactionManager newTM(Collection<Resource> resources, LocalTimeProvider timeProvider)
	{
		return new TranscactionManagerImpl(resources, timeProvider);
	}
